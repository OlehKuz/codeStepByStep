/*  Take current element from an array, look through the next values of an array.
    ...
    which is what an answer should be, but because we will be looping over array incrementing indexes one in a time, 
    ...
    So we need to increment dublicates by 1 if counter is >=1, to avoid the situation of overcounting doubles described before.
    */
